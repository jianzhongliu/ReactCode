...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('div', { style: { borderWidth: '1px', borderColor: '#d3d3d3', borderStyle: 'solid' } }, _react2.default.createElement('div', { className: 'register-phone' }, _react2.default.createElement(_button2.default, { style: { float: 'right', top: '5px', height: '30px', width: '100px', fontSize: '14px', fontColor: '#d6d6d6' }, type: 'primary' }, '\u53D1\u9001\u9A8C\u8BC1\u7801'), _react2.default.createElement('input', { type: 'text', style: { height: '40px', width: '100%', padding: '0', 'borderBottom': '1px solid #ffffff'
				},
				placeholder: '\u8BF7\u8F93\u5165\u624B\u673A\u53F7',
				onChange: this.onChangeUserName })), _react2.default.createElement('input', { type: 'text', style: { height: '40px', width: 'calc(100% - 2px)', padding: '0', 'borderBottom': '1px solid #ffffff' },
				placeholder: '\u8BF7\u8F93\u77ED\u4FE1\u9A8C\u8BC1\u7801',
				onChange: this.onChangeUserName }), _react2.default.createElement('input', { style: { height: '40px', width: 'calc(100% - 2px)', padding: '0', 'borderBottom': '1px solid #ffffff' },
				placeholder: '\u6635\u79F0',
				onChange: this.onChangeUserName }), _react2.default.createElement('input', { type: 'text', style: { height: '40px', width: 'calc(100% - 2px)', padding: '0', 'borderBottom': '0.3px solid #ffffff' },
				placeholder: '\u8BF7\u8F93\u5165\u5BC6\u7801',
				onChange: this.onChangeUserName }), _react2.default.createElement('input', { type: 'text', style: { height: '40px', width: 'calc(100% - 2px)', padding: '0', 'borderBottom': '0.3px solid #ffffff' },
				placeholder: '\u8BF7\u786E\u8BA4\u65B0\u5BC6\u7801',
