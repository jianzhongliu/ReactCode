...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('div', { style: { borderWidth: '1px', borderColor: '#d3d3d3', borderStyle: 'solid' } }, _react2.default.createElement('div', { className: 'reg-form' }, _react2.default.createElement('div', { className: 'input-field' }, _react2.default.createElement(_button2.default, { style: { float: 'right', top: '5px', height: '30px', width: '100px', fontSize: '14px', fontColor: '#d6d6d6' }, type: 'primary' }, '\u53D1\u9001\u9A8C\u8BC1\u7801'), _react2.default.createElement('input', { type: 'text',
				placeholder: '\u8BF7\u8F93\u5165\u624B\u673A\u53F7',
				onChange: this.onChangeUserName })), _react2.default.createElement('div', { className: 'input-field' }, _react2.default.createElement('input', { style: { height: '40px', width: '100%', padding: '0' },
				placeholder: '\u6635\u79F0',
