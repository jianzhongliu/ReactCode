...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('div', { style: { borderWidth: '1px', borderColor: '#d3d3d3', borderStyle: 'solid' } }, _react2.default.createElement('div', { className: 'register-phone' }, _react2.default.createElement('div', { style: { height: '40px', marginRight: '100px', backgroundColor: '#d8d8d8' } }), _react2.default.createElement('div', { style: { height: '30px', width: '100px', marginLeft: '-50px', fontSize: '14px', fontColor: '#d6d6d6' }, type: 'primary' }, '\u53D1\u9001\u9A8C\u8BC1\u7801')), _react2.default.createElement(_input2.default, { style: { height: '40px', width: 'calc(100% - 2px)', padding: '0' },
				placeholder: '\u8BF7\u8F93\u77ED\u4FE1\u9A8C\u8BC1\u7801',
